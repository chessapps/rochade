...
from seebach.features.standings.get_standings import SectionStandings, standings_of
from seebach.interchange.formats.swiss_manager_text import split_blocks
...
from seebach.shared.enums import EventAction, RoundState
from seebach.shared.models import Section
from seebach.swiss_manager.player_file import PlayerFileError, parse_player_file
