...
from rochade.swiss_manager.pairing_file import HEADER as PAIRING_HEADER
from rochade.swiss_manager.pairing_file import PairingFileError, parse_pairing_file
